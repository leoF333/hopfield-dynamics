...
*Generated 2026-08-20. Machine-readable version: `docs/claims.csv`.*
...
- **Data** — `[local archive] obsolete/03_legacy_code/Projet_Chicago/stabilité/système continu/phases & comparaison/phases continu/  (walkthrough.md + arrays)`
...
- **Data** — `data/2_recall_cycle_snic/data/E9_bond_times.npz`
- **Code** — `code/core/pacemaker_scan.py ; code/core/cycle_figures.py`
- **Figure** — Figure06_snic.png (d, inset)
- **Write-up** — `docs/worklogs/CYCLE_worklog.md E9`
- **Status** — **Established**
...
- **Code** — `code/core/reduced_spectrum.py ; code/core/robust_branch.py ; code/core/regen_figs_english.py  (figF)`
- **Figure** — Figure06_snic.png (c)
- **Write-up** — `docs/worklogs/CYCLE_worklog.md E12`
- **Status** — **Established**
- **Notes** — E12 was run as an ad-hoc driver on top of the exact Sylvester spectrum, not as a committed e12_*.py script; the protocol, the eig_max(lambda) table and the fit are recorded in full in the worklog entry, and the figure is regenerated by regen_figs_english.py.
...
- **Write-up** — `docs/worklogs/CYCLE_worklog.md E11/E13/E14 ; docs/worklogs/FLOQUET_methodology.md`
- **Status** — **Established**
...
- **Figure** — Figure10_correlations.png (a,b)
- **Write-up** — `docs/worklogs/CYCLE_worklog.md E27 ; docs/worklogs/LITERATURE_correlated_patterns.md`
- **Status** — **Established**
...
- **Figure** — Figure10_correlations.png (c,d)
...
| Figure06 | traceable | `NONE - rebuilt 2026-08-20 from the stored components` | `code/figures/manuscript/build_figure06_snic.py` |
...
| Figure10 | traceable | `NONE - built 2026-08-20 by merging the former Figure10 (Markov, E27) and Figure11 (circular GP, E28)` | `code/figures/manuscript/build_figure10_correlations.py` |
